...
function clearModuleForm() {
    ...
    document.getElementById('customModuleNotice').style.display = 'none';
}
...
function populateModuleCodeList() {
    ...
    const allModules = [...programmeModules, ...BREADTH_MODULES, ...DISCOVERY_YEAR_MODULES];
...
function handleModuleCodeInput(e) {
    ...
    const customNotice = document.getElementById('customModuleNotice');
    ...
    if (module) {
        // Module found in database - auto-fill
        ...
        // Module not found - show custom entry notice
...
function updateDashboard() {
    ...
    const categories = [
        ...
        { name: 'Major Core', icon: '📚', required: 48, color: '#10b981' },
        { name: 'Major Option', icon: '🔬', required: 36, color: '#f59e0b' },
        { name: 'Discovery Year', icon: '🧭', required: 32, color: '#8b5cf6' },
        { name: 'Outside Breadth', icon: '🌐', required: 8, color: '#06b6d4' }
    ];
...
function updateBreakdown() {
    ...
    if (totalCredits >= 152) {
        ...
        const breakdown = {
            ...
            'Major Core': { completed: 0, required: 48 },
            'Major Option': { completed: 0, required: 36 },
            'Discovery Year': { completed: 0, required: 32 },
            'Outside Breadth': { completed: 0, required: 8 }
        };
    ...
    const categories = [
        ...
        { name: 'Major Core', required: 48 },
        { name: 'Major Option', required: 36 },
        { name: 'Discovery Year', required: 32 },
        { name: 'Outside Breadth', required: 8 }
    ];
